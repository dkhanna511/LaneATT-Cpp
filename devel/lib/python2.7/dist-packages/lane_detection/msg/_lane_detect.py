...
"""autogenerated by genpy from lane_detection/lane_detect.msg. Do not edit."""
import codecs
import sys
...
class lane_detect(genpy.Message):
  _md5sum = "1ec713989d8e6daf5b7ceba45fb0a04f"
  _type = "lane_detection/lane_detect"
...
"""
  __slots__ = ['header','num_of_lanes','lane','num_of_points','frame']
  _slot_types = ['std_msgs/Header','int32','geometry_msgs/Point[]','float32[]','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,num_of_lanes,lane,num_of_points,frame
